...
<div>
  <img className='lg:flex lg:ml-56 h-screen lg:h-[600px]' src='/projects/les_poings_ouverts/Les poings ouverts Anouk Desury_190.webp' alt='photo de profil d Anouck Desury' />
</div>
  </Layout>)
}
